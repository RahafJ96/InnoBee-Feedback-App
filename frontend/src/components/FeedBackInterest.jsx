      ...
      >
        <div className=" bg-gray-900 rounded-lg px-6 py-5 border-4 border-gray-200">
          ...
          <div className="max-w-[600px] relative mb-4 w-full flex flex-col gap-4">
            <div
              className="flex items-center gap-2 px-2 py-1 border-1 border-gray-200 rounded-lg cursor-pointer hover:bg-gray-300 transition-all"
            ...
            >
              <button
                className={`w-6 h-6 rounded-full flex items-center justify-center ${
                  isNotInterested
                    ? "bg-pri-color"
                    : " bg-gray-900 border-1 border-gray-200"
                }`}
          ...
          <p className="text-xs text-gray-500 mt-4 mb-4">
            ...
            opportunities related to InnoBee. See our{" "}
            <a href="#" className="underline text-pri-color">
              Privacy Policy
            </a>{" "}
            for more details.
          </p>
